#include "asgn6_19CS10048_19CS30014_translator.h"
#include <bits/stdc++.h>
        ...
        if(op == 'PARAM') {
            ...
            if(op == "ADD") {
                ...
                if(flag) {
                    ...
                    assmFile << "\tmovl \t" << table->ar[arg2] << "(%rbp), " << "%edx"<<endl;
                ...
                else assmFile<<"\timull \t" << table->ar[arg2] << "(%rbp),  %eax" << endl;
                assmFile << "\tmovl \t%eax, " << table->ar[result] << "(%rbp)";
            }
            else if(op == "DIVIDE") {
                assmFile << "movl \t" << table->ar[arg1] << "(%rbp), " << "%eax"<<endl;
                ...
                if(result != "") assmFile << "movl\t" << table->ar[result] << "(%rbp), %eax" << endl;
                assmFile << "nop";
            }
            else if(op == "PARAM") {
                params.push_back(result);
				...
				assmFile << "\t.cfi_def_cfa_offset 8" << endl << "\t.cfi_offset 5, -8" << endl;
